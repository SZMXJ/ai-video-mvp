...
export default function PreviewCard({ item: it, onRefresh }: Props) {
      ...
      <div className="p-3 sm:p-4">
        {it.outputUrl ? (
          isVideo ? (
            ...
            <div className="flex h-[320px] items-center justify-center text-white/40">Output ready, but type unknown.</div>
          )
        ) : (
